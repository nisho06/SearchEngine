...
from scrapeFunctions import birth, paragraph
...
csv_columns = ['இலக்கம்', 'பெயர்', 'அறிமுக வருடம்', 'அறிமுக படம்', 'பிறந்த திகதி', 'பிறந்த இடம்', 'அறிமுகம்',
               'உள்ளடக்கம்']
...
csv_file = 'LoadBulkElasticSearch/data.csv'
